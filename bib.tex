...
\begin{itemize}[nosep]
  ...
  \item \textbf{Язык \cpp, утилиты GNU toolchain} (gcc/g++, make, ld)\\базовый
  Си, ООП очень кратко\note{наследование, полиморфизм, операторы для
  пользовательских типов, использование библиотеки STL}, без излишеств
  профессионального программирования\note{мегабиблиотека Boost, написание своих
  библиотек шаблонов и т.п.}, чисто вспомогательная роль для написания
  вычислительных блоков и критичных к скорости/памяти секций, использовать в
  связке с Python.\\
